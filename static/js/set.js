...
var flagg_=1
//alert(flag)
//<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=91,appendText()' >了解赔偿标准</a><br> 
...
var pre0="<a href='javascript:void(0)' class='res-link' target='_self' onclick='flagg_=1,appendText()' >1.快递问题  </a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=2,appendText()'>2.网络贷款问题</a> <br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=3,appendText()' >3.手机软件扣费  </a><br>  <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=4,appendText()' >4.医疗问题 </a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=5,appendText()' >5.商标或关键词侵权问题 </a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=6,appendText()' >6.网络购物问题</a><br><a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=7,appendText()' >7.投资理财被诈骗问题</a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=8,appendText()' >8. 发票问题</a><br>" 
var pre1="<a href='javascript:void(0)' class='res-link' target='_self' onclick='flagg_=11,appendText()' >1.1 快递太慢</a><br><a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=12,appendText()' >1.2 快递丢失</a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=13,appendText()' >1.3 快递物件损坏</a><br>  "
var pre11="您好，根据您反映的情况，由于工作失误，快递对您的快件送达延误，给您造成损失对此，建议您登录<a href=' http://sswz.spb.gov.cn/' class='res-link' target='_blank'  > 国家邮政局申诉网站</a> 电话（当地区号+024-12305） 微信（邮政业消费者申诉）进行投诉，并保留好您所有的证据，等待对方处理。 （注意需满足申诉条件：①已向企业投诉，但七天内没有任何处理结果 ②已向企业投诉，但对企业的处理结果不满意。投诉方可被受理）  \n\n<br>    根据《邮政业消费者申诉处理办法》 第八条 消费者申诉受理范围： （二）经营快递业务企业的快递业务服务质量问题。 第十条 邮政业消费者申诉中心应当及时受理消费者申诉。消费者采取电话方式申诉，应当及时接听，并告知申诉人处理流程与时限。消费者采取网上、书信、传真形式申诉，应当于两个工作日内处理。 \n\n<br> 第十四条 被申诉企业收到邮政业消费者申诉中心转办的申诉后应当按照以下情形妥善处理： （一）对确认企业负有责任的申诉，应当依法赔偿消费者损失或者向消费者致歉；  \n\n<br>第十五条 被申诉企业应当按照如下要求，自收到转办申诉之日起十五日内向转办申诉的邮政业消费者申诉中心答复处理结果  \n\n<br>      鼓励您增强维权意识！ \n\n<br><a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=91,appendText()' >了解赔偿标准</a><br> "+
"&nbsp&nbsp<br>是否解决您的问题？<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=99,appendText()' >是</a>&nbsp&nbsp&nbsp   "
+"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=98,appendText()' >否</a>";
...
var pre4="<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=41,appendText()' >4.1 医疗过程中又不必要的检查项目和药物</a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=42,appendText()' >4.2 医疗过程中药物或诊费过高</a><br>";
...
var pre5="<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=51,appendText()' >5.1我的商标被他人冒用</a><br> <a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=52,appendText()' >5.2 我的关键词被占用</a><br>";
...
var pre6="<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=61,appendText()' >6.1 网络购物付款后对方不发货</a><br>"+
	"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=62,appendText()' >6.2网购货物质量有问题</a><br>"+
	"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=63,appendText()' >6.3申请退货退款过程中的问题</a><br>"+
	"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=64,appendText()' >6.4 商品描述与实物不符</a><br>";
...
var pre8="<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=81,appendText()' >8.1拒绝开发票</a><br>"+
	"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=82,appendText()' >8.2 开发票金额过小</a><br>"+
	"<a href='javascript:void(0)' class='res-link' target='_blank' onclick='flagg_=83,appendText()' >8.3开发票不规范</a><br>";
...
var rep="感谢您的使用！";
var pre98 = "很遗憾，自动恢复系统未能解决您的问题，请登录<a href='https://koubei.baidu.com/m2' target='_blank' >网站</a>手动投诉。"
function appendText()
{
 	switch(flagg_)
 	{
