...
var pre83="一、案情分析 <br>" +
	...
	"（一）应当开具而未开具发票，或者未按照规定的时限、顺序、栏目，全部联次一次性开具发票，或者未加盖发票专用章的； <br>" +
	"三、相关建议 <br>" +
	"建议您向对方所在地的税务部门投诉，依法维权 <br>&nbsp&nbsp<br>是否解决您的问题？<a href='javascript:;' class='res-link' target='_blank' onclick='flagg_=99,appendText()' >是</a>&nbsp&nbsp&nbsp   <a href='https://koubei.baidu.com/m2' target='_blank' >否</a>";
